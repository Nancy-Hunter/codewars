...
function spoonerize(words) {
    ...
    let firstWord = wordArray[0].split("")
    let secondWord = wordArray[1].split("")
    let letterHoldingCell = firstWord.shift()
    
    firstWord.unshift(secondWord[0])
    secondWord.shift()
    secondWord.unshift(letterHoldingCell)
