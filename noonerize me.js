...
function noonerize(numbers) {
    ...
    let firstNumber = numbers[0].toString().split("")
    let secondNumber = numbers[1].toString().split("")
    
    let numberHoldingCell = firstNumber.shift()
    
    firstNumber.unshift(secondNumber[0])
    secondNumber.shift()
    secondNumber.unshift(numberHoldingCell)
